...
void CSoundMgr::PlayBGM(TCHAR * pSoundKey)
{
	...
	FMOD_System_PlaySound(m_pSystem, FMOD_CHANNEL_FREE, iter->second, FALSE, &m_pChannelArr[CHANEL_BGM]);
	FMOD_Channel_SetMode(m_pChannelArr[CHANEL_BGM], FMOD_LOOP_NORMAL);
	FMOD_System_Update(m_pSystem);
}
